 ...
 *  ║  步进电机: P1.0~P1.3 → ULN2003 → 28BYJ-48            ║
...
/* ======================== 步进电机 (ULN2003 驱动) ======================== */
/*
 * 28BYJ-48 步进电机, ULN2003 驱动
 * P1.0 → ULN2003.IN1 → 电机 A 相
 * P1.1 → ULN2003.IN2 → 电机 B 相
 * P1.2 → ULN2003.IN3 → 电机 C 相
 * P1.3 → ULN2003.IN4 → 电机 D 相
 *
...
u8  effective_speed;    // 实际步进延时索引: 0~4 (受自然风/睡眠风影响)
 ...
 * 参数    : 无
 * 返回值  : 无
 * 说明    : effective_speed 是 step_delay[] 数组的索引 (0~4)
 *           常风模式: 直接使用用户设定档位
